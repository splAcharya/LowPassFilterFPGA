...
HD_PWD='E:/ECE_471/Labs/nexysFIR/blockDiag/stateMachineFirlet/stateMachineFirlet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log _main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source _main.tcl -notrace
