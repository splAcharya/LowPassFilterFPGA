...
HD_PWD='E:/ECE_471/Labs/nexysFIR/blockDiag/stateMachineFirlet/stateMachineFirlet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _main.tcl
